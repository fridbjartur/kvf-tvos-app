...
The app reads its default API base URL from `EXPO_PUBLIC_KVF_API_BASE_URL`.
If that variable is not set, it falls back to the home NAS API:
`http://192.168.1.10:3939`.
...
You can also override the URL from the in-app Settings screen. The saved
Settings value wins until you reset it.
